...
<html lang="en">
  <head>
    ...
    <title>Bad Condition Tools</title>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row['tool_Description'] . "</td>";
                            echo "<td>" . $row['tool_Location'] . "</td>";
                            echo "<td>" . $row['tool_Quantity'] . "</td>";
                            echo "<td>" . $row['tool_Condition'] . "</td>";                            
                            echo "<td class='action-buttons'>
                            <a href='edit_tools.php?id=" . $row['record_ID'] . "' class='btn-edit' onclick='confirmEdit(event)'><i class='bx bx-edit-alt'></i></a>
                            <a href='delete_tools.php?id=" . $row['record_ID'] . "' class='btn-delete' onclick='confirmDelete(event)'><i class='bx bxs-message-square-minus'></i></a>
                          </td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='12'>No tools found</td></tr>";
                    }
                    $stmt->close();
                    $connect->close();
                    ?>
